                    ...
                    <form action="{{ route('barters.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4 p-3 bg-gray-50 rounded-lg border border-gray-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <!-- Client -->
                                <div>
                                    <label for="client_id" class="block text-sm font-medium text-gray-700">Client <span
                                ...
                                <!-- Boutique -->
                                <div>
                                    <label for="shop_id" class="block text-sm font-medium text-gray-700">Boutique <span
                                            class="text-red-500">*</span></label>
                                ...
                                <!-- Vendeur -->
                                <div>
                                    <label for="seller_id" class="block text-sm font-medium text-gray-700">Vendeur <span
                                            class="text-red-500">*</span></label>
                                ...
                                <!-- Type de troc -->
                                <div>
                                    <label for="type" class="block text-sm font-medium text-gray-700">Type de troc
                                        <span class="text-red-500">*</span></label>
                                    <select name="type" id="type"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                        required>
                                        <option value="same_type" {{ old('type') == 'same_type' ? 'selected' : '' }}>
                                            Même type</option>
                                        <option value="different_type"
                                            {{ old('type') == 'different_type' ? 'selected' : '' }}>Types différents
                                        </option>
                                    </select>
                                    @error('type')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        ...
                        <div class="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-100">
                            ...
                            <div id="given-items-container">
                                <div class="given-item border-b border-blue-200 pb-3 mb-3">
                                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        <div>
                                            <label class="block text-sm font-medium text-blue-700">Nom <span
                                                    class="text-red-500">*</span></label>
                                            <input type="text" name="given_items[0][name]"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                                required>
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-blue-700">Valeur unitaire <span
                                                    class="text-red-500">*</span></label>
                                            <input type="number" step="0.01" min="0"
                                                name="given_items[0][value]"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                                required>
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-blue-700">Quantité <span
                                                    class="text-red-500">*</span></label>
                                            <input type="number" min="1" name="given_items[0][quantity]"
                                                value="1"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                                required>
                                        </div>
                                        <div class="md:pt-6">
                                            <button type="button"
                                                class="text-xs bg-red-500 text-white py-1 px-2 rounded hover:bg-red-600 remove-given-item hidden">Supprimer</button>
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label
                                            class="block text-sm font-medium text-gray-700 mb-1">{{ __('Images du troc') }}</label>
                                        <div class="mb-4 p-3 bg-gray-50 rounded-lg border border-gray-100">
                                            <h3 class="text-lg font-medium mb-3 text-gray-700">
                                                {{ __('Images du Troc') }}</h3>
                                            <div class="space-y-2">
                                                <div class="flex items-center space-x-2">
                                                    <input type="file" name="images[]" id="images"
                                                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-1 file:px-4 file:rounded file:border-0 file:text-sm file:font-medium file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100"
                                                        multiple accept="image/*">
                                                </div>
                                                <p class="text-xs text-gray-500">
                                                    {{ __('Format acceptés: JPEG, PNG. Max 2MB par image') }}</p>
                                            </div>
                                        </div>
                                        <p class="text-xs text-gray-500 mt-1">
                                            {{ __('Sélectionnez les images illustrant le troc (JPEG, PNG, max 2MB par image)') }}
                                        </p>
                                    </div>

                                    <div class="mt-2">
                                        <label class="block text-sm font-medium text-blue-700">Description</label>
                                        <textarea name="given_items[0][description]" rows="1"
                            ...
                            <button type="button" id="add-given-item"
                                class="mt-2 inline-flex items-center px-2 py-1 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            ...
                            <div id="received-items-container">
                                <div class="received-item border-b border-green-200 pb-3 mb-3">
                                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                                        <div>
                                            <label class="block text-sm font-medium text-green-700">Nom <span
                                                    class="text-red-500">*</span></label>
                                            <input type="text" name="received_items[0][name]"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                                required>
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-green-700">Valeur unitaire
                                                <span class="text-red-500">*</span></label>
                                            <input type="number" step="0.01" min="0"
                                                name="received_items[0][value]"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                                required>
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-green-700">Quantité <span
                                                    class="text-red-500">*</span></label>
                                            <input type="number" min="1" name="received_items[0][quantity]"
                                                value="1"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                                required>
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-green-700">Produit
                                                (optionnel)</label>
                                            <select name="received_items[0][product_id]"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                        ...
                                        <div class="md:pt-6">
                                            <button type="button"
                                                class="text-xs bg-red-500 text-white py-1 px-2 rounded hover:bg-red-600 remove-received-item hidden">Supprimer</button>
                                        </div>
                                    </div>
                                    <div class="mt-2">
                                        <label class="block text-sm font-medium text-green-700">Description</label>
                                        <textarea name="received_items[0][description]" rows="1"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                                    </div>
                                </div>
                            </div>

                            <button type="button" id="add-received-item"
                                class="mt-2 inline-flex items-center px-2 py-1 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    <path fill-rule="evenodd"
                                        d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z"
                        ...
                        <div class="mb-4 p-3 bg-yellow-50 rounded-lg border border-yellow-100">
                            <h3 class="text-md font-medium text-yellow-700 mb-2">Paiement complémentaire (si
                                nécessaire)</h3>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="payment_method"
                                        class="block text-sm font-medium text-yellow-700">Méthode de paiement</label>
                        ...
                        <div class="flex justify-end mt-4">
                            <a href="{{ route('barters.index') }}"
                                class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300 mr-2">Annuler</a>
                            <button type="submit"
