...
{
    /**
     * Tables système: users, sessions, cache, jobs, settings
     */
    public function up(): void
    {
        // Users et tables associées
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->decimal('commission_rate', 5, 2)->default(0)->comment('Taux de commission en pourcentage');
