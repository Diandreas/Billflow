...
class Activity extends Model
{
    ...
    /**
     * Obtenir le modèle associé à cette activité
     */
     ...
     * @return Activity
     */
    public static function log($action, $modelType = null, $modelId = null, $oldValues = null, $newValues = null, $description = null)
    {
        $user = auth()->user();
